...
public class FileHandler {
	 ...
	 /**
	  * Reading CSV
	  * the method return a feature object after reading the geometry type from the CSV file
	  * @param file
	  * @throws IOException
	  */
	 ...
	 */
	 public static Feature readFromGeoJson(String SelectedDatum) {
		...
		// testing the selected datum by the user.
    ...
    /*
     * setting the transformation parameter
     */

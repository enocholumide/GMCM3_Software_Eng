...
public class Layer implements Comparable<Layer> {
	...
	/** The default fill color of a layer */
	private Color layerFillColor = SettingsFrame.DEFAULT_LAYER_COLOR;
	/** The default outline color of a layer */
	...
	public Layer(int id, boolean isVisible, String layerType,  String layerName) {
		//super(id);
		this.id = id;
		this.setRenderingIndex(id);
		this.layerName = layerName;
		this.isVisible = isVisible;
		this.layerType = layerType;
		this.tableData = new Object[] {isVisible, layerType, layerName, "", id};
		
		Color ranColor = Tools.getRandomColor();
		setFillColor(ranColor);
		setOutlineColor(ranColor);
	}
	 ...
	 */
	public void setFillColor(Color layerColor) {
		this.layerFillColor = layerColor;
	}

	public Color getOutlineColor() {
		return layerOutlineColor;
	}

	public void setOutlineColor(Color layerOutlineColor) {
		this.layerOutlineColor = layerOutlineColor;
	}
	...
	public int compareTo(Layer that) {
		return String.valueOf(this.renderingIndex).compareTo(String.valueOf(that.renderingIndex));
	}
}
